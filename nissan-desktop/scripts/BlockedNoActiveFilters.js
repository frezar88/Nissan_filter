    ...
    inputsState.forEach(element => {
        if (element.defaultValue == 'Новый' && element.checked == true) {
            ...
            fdsfds.forEach(element => {
                element.parentNode.classList.add('bu')
                let sss = document.querySelector('.filter-list__content')
                sss.style.display='block'
            });
        }
        if (element.defaultValue == 'Новый' && element.checked == false) {
            let fdsfds = document.querySelectorAll('.bu')
            fdsfds.forEach(element => {
                element.classList.remove('bu')
            });
        }
        ...
        if (element.defaultValue == 'Б/У' && element.checked == false) {
            let fdsfds = document.querySelectorAll('.new')
            fdsfds.forEach(element => {
